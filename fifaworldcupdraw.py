...
# ============================================
# 6. FUNCTION — COUNT CONTINENTS ACROSS ALL POTS
# ============================================
...
def check_continents(i, group_list):
    ...
    # Otherwise all non-negative → return True
    return True
...
def swap_group_by_team(groups_list, team_name, target_index):
    # Step 1 — find current index of the team
    current_index = None
    ...
    # Step 2 — swap the whole group element
...
def random_assignment_ABCD_list():
    # 4 lists (groups)
    lists = [
        [4, 5, 8],   # index 0 → top half
        [6, 7],      # index 1 → top half
        [2, 11],     # index 2 → bottom half
        [9, 10],     # index 3 → bottom half
    ]
